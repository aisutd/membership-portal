    ...
    <div>
      ...
      <main>
        <div className="flex flex-col lg:flex-row">
          <div className="bg-gray w-screen h-screen left-0 relative">
            ...
            <div className="flex flex-col justify-center items-center mt-5">
              <div>
                <p className="text-white text-5xl font-sans subpixel-antialiase tracking-wide font-bold">AIS Membership</p>
              </div>
              <div>
                <p className="text-white text-5xl font-sans subpixel-antialiase justify-center tracking-wide font-bold">Portal</p>
              </div>
              <div className="justify-center mt-2">
                <p className="text-white text-lg font-sans subpixel-antialiase tracking-wide font-bold">
                  Welcome to the Membership Portal. Here you can find&nbsp;&nbsp;&nbsp; <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;information about our exclusive events, open <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;applications, and attendance information
                </p>
              </div>
            </div>

            <div className="absolute inset-x-0 bottom-10 flex flex-row justify-center space-x-8">
              <div>
                <svg width="40" height="40" viewBox="0 0 41 40" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="bg-white w-screen h-screen right-0 relative">

          ...
          <div className="bg-white w-screen h-screen right-0 relative">
            <div className="flex flex-col justify-center items-center pt-96">
              ...
              <a onClick={() => signIn("cognito")}>
                <div className="flex flex-row rounded border border-gray-400 mt-2">
                  ...
                  <p className="m-4 mr-8 pr-3 font-bold tracking-wide text-lg text-gray-400">Sign In with Google</p>
                </div>
              </a>
              <a href="https://coda.io/form/AIS-Membership-Application_dNezXZc0_Z1">
                <div className="flex flex-row rounded border border-gray-400 mt-5">

        ...
        <div className="pt-8 pb-2 px-6">
          <div className="hidden md:flex flex-col items-center">
            <div className="shrink-0">
              <div
                className="rounded-full w-20 h-20  border-white bg-gradient-to-bl from-blue-400 to-blue-800 "
                alt="Avatar"
              >
                {" "}
              </div>
            ...
            <div className="grow ml-3 text-center">
              <p className="text-sm font-semibold text-white pt-6">
                AIS Member
              </p>
          ...
          <Link href="/" passHref>
            ...
            >
              <div className="flex flex-row">
                ...
                <p className="hidden md:block w-3/4 text-left  mt-1 text-md">
                  Home
                </p>
              </div>
            </a>
          ...
          <div>
            ...
            >
              <a href="https://www.linkedin.com/company/ais-utd/">
                <path
                  d="M31.768 5.33337H7.98463C6.5246 5.33337 5.34204 6.52671 5.34204 8.00004V32C5.34204 33.4734 6.5246 34.6667 7.98463 34.6667H31.768C33.228 34.6667 34.4106 33.4734 34.4106 32V8.00004C34.4106 6.52671 33.228 5.33337 31.768 5.33337ZM14.5303 29.3334H10.6325V16.6774H14.5303V29.3334ZM12.5418 14.868C11.2852 14.868 10.2692 13.84 10.2692 12.5747C10.2692 11.3094 11.2866 10.2827 12.5418 10.2827C13.7944 10.2827 14.8131 11.3107 14.8131 12.5747C14.8131 13.84 13.7944 14.868 12.5418 14.868ZM29.1307 29.3334H25.2355V23.1787C25.2355 21.7107 25.2091 19.8227 23.2099 19.8227C21.1817 19.8227 20.8699 21.4214 20.8699 23.072V29.3334H16.9747V16.6774H20.714V18.4067H20.7669C21.2874 17.412 22.5585 16.3627 24.4546 16.3627C28.4013 16.3627 29.1307 18.984 29.1307 22.392V29.3334Z"
                  fill="white"
                />
              </a>
            </svg>
